...
<div class="center-box box-column" style="padding-top: 20px; padding-bottom: 20px; ">
    <form:form id="unitForm" method="post" modelAttribute="unit" action="processUnit.html" class="unit-form">
        <div class="unit-form-box" >
            <div class = "unit-form-title">Registro de Unidade</div> 
            <div class = "unit-form-groups">                   
                ...
                <div class="form-group">
                    ...
                    <a  href="requestHotel.html" target="_blank">Não encontrou seu Hotel?</a> 
                </div> 
                <div class="form-group">
            ...
            <div id="uploadList" class="images-box">
                <c:forEach items="${hotel.medias}" var="medias" varStatus="st">
                    <div class="unit-form-image-item">
                        ...
                        <div class="unit-form-image" style="background-image: url(${pageContext.request.contextPath}/images/temp/units/${medias.name})"> </div>                                                
