...
<div class="center-box box-column" style="padding-top: 20px; padding-bottom: 20px; "> 
    <form:form id="hotelForm" method="post" modelAttribute="hotel" action="processHotel.html" class="hotel-form">
        <div class="hotel-form-box" >
            <div class = "hotel-form-title">Registro de Hotel</div> 
            ...
            <div id="uploadList" class="images-box">
                <c:forEach items="${hotel.medias}" var="medias" varStatus="st">
                    <div class="hotel-form-image-item">
                        ...
                        <div class="hotel-form-image" style="background-image: url(${pageContext.request.contextPath}/images/temp/hotels/${medias.name})"> </div>                                                
